...
public function inicion (){
        $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('inicio');
}
    public function gruposn()
    {
        $this->load->view('assets'); 
         $this->load->view('head'); 
        $this->load->view('grupos'); 
    }
    public function cuestionariosn(){
        $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('cuestionarios');
}
    
    public function preguntasn (){
        $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('preguntas');
}
     
    public function resultadosn (){
         $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('resultados');
}
    public function appn (){
         $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('app');
}
     public function admyon (){
         $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('admyo');
}


public function gruposnr()
    {
        $this->load->view('assets'); 
         $this->load->view('head'); 
        $this->load->view('gruposr'); 
    }
    public function cuestionariosnr(){
        $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('cuestionariosr');
}
   
    public function preguntasnr (){
        $this->load->view('assets'); 
        $this->load->view('head');
        $this->load->view('preguntasr');
}
public function graficasn (){
         $this->load->view('assets'); 
        $this->load->view('head');
...
public function resumenn (){
        $this->load->view('assets'); 
        $this->load->view('head');
     $this->load->view('resumen');

}
public function detallesn (){
         $this->load->view('assets'); 
        $this->load->view('head');
