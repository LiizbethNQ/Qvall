						...
						<div class="col-12 text-rigth m-t-20"><!---->
							<div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Pregunta" aria-label="Input group example" aria-describedby="btnGroupAddon2">
...
<!------------------------------MENU EN CONJUNTO----------------------------------------------------------------->
									...
									<button type="button" class="btn btn-primary" onclick="$('#msjaltap').iziModal('open')"> <i class="fa fa-user-plus"></i>Alta Pregunta </button>
