...
class Model_Cuestionarios extends CI_Model
{
	...
	public function getCuestionarios($empresas,$estatus){
		...
		//funcion con 3 parametro $estatus =1 $estatus1 =0
		// $get=$this->db->select("*")->where("IDEmpresa='$empresas' and Status='$estatus' || Status='$estatus1'")->get("cuestionario");
	...
	public function nombreperfil($numero,$tipo){
			...
			$sql=$this->db->select('Nombre')->where("IDGrupo='$numero'")->get("grupos");
			return $sql->row()->Nombre;
